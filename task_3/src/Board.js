class Board {
    ...
    isNextStepAfterWall(nextCellCoords) {
        if (nextCellCoords.x == 0 && this.snake.direction == 'left') {
            nextCellCoords.x = this.settings.rowsCount;
        }
        if (nextCellCoords.x == this.settings.rowsCount + 1 && this.snake.direction == 'right') {
            nextCellCoords.x = 1;
        }
        if (nextCellCoords.y == 0 && this.snake.direction == 'up') {
            nextCellCoords.y = this.settings.colsCount;
        }
        if (nextCellCoords.y == this.settings.rowsCount + 1 && this.snake.direction == 'down') {
            nextCellCoords.y = 1;
        }
    }
