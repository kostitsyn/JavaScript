let mover = {
    ...
    getNextPosition(direction) {
        ...
        // Проверяем условие отсутствия шага в стенку
        if (nextPosition.x == 0 && [1, 4, 7].includes(direction)) {
            nextPosition.x = 0;
        } else if (nextPosition.y == 0 && [7, 8, 9].includes(direction)) {
            nextPosition.y = 0;
        } else if (nextPosition.x == 9 && [3, 6, 9].includes(direction)) {
            nextPosition.x = 9;
        } else if (nextPosition.y == 9 && [1, 2, 3].includes(direction)) {
            nextPosition.y = 9;
        } else {
